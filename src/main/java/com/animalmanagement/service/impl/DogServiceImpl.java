...
public class DogServiceImpl implements DogService {
     ...
     * @param id It is a unique field of dog class on which we can find a particular dog among list of dogs.
     */
    ...
    public List<Dog> getDogsBetweenDogCodes(String firstId,
    		String secondId) throws AnimalManagementException {
        return dogDao.getDogsBetweenDogCodes(firstId,secondId);

    }
    // to do
   /* public Dog getDogWithFoods(String dogCode)  {
        return dogDao.getDogWithFoods(dogCode);
    }*/
